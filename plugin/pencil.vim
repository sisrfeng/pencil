...
let s:save_cpoptions = &cpoptions  | set cpoptions&vim
...
" Commands
    ...
    com   -bar -nargs=0 Pencil         call pencil#init({'wrap': 'on' })
    com   -bar -nargs=0 PencilOff      call pencil#init({'wrap': 'off' })
    com   -bar -nargs=0 NoPencil       call pencil#init({'wrap': 'off' })
    com   -bar -nargs=0 HardPencil     call pencil#init({'wrap': 'hard'})
    com   -bar -nargs=0 PencilHard     call pencil#init({'wrap': 'hard'})
    com   -bar -nargs=0 SoftPencil     call pencil#init({'wrap': 'soft'})
    com   -bar -nargs=0 PencilSoft     call pencil#init({'wrap': 'soft'})
    com   -bar -nargs=0 PencilToggle   call pencil#init({'wrap': 'toggle'})
    com   -bar -nargs=0 TogglePencil   call pencil#init({'wrap': 'toggle'})
    com   -bar -nargs=0 PFormat        call pencil#setAutoFormat(1)
    com   -bar -nargs=0 PFormatOff     call pencil#setAutoFormat(0)
    com   -bar -nargs=0 PFormatToggle  call pencil#setAutoFormat(-1)
